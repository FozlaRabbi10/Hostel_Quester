...
class PagesController extends Controller
{
    public function index()
    {
        ...
        $data = ["mees" => $mees,"locations" => $locations];
    ...
    public function myProfile()
    {
        ...
        if(auth() -> user() -> is_admin === 1)
            $mess_records = Mees::all();
        else
            $mess_records = auth() -> user() -> mees;
        return view('pages.profile',['locations' => $locations,'mess_records' => $mess_records]);
    }
    public function nearbyMe()
    {
        return view('pages.nearmess');
    }
